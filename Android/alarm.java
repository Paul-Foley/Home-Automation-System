...
public class alarm extends AppCompatActivity {
    ...
    static final String LOG_TAG = com.paulfoleyblogs.paul.homeseccontrol.gates.class.getCanonicalName();
    ...
    private static final String AWS_IOT_POLICY_NAME = "Alarm_Policy";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aSwitch = (Switch) findViewById(R.id.switch5);
        aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {

                    final String topic = "$aws/things/Alarm/shadow/update";
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "device Page", // TODO: Define a title for the content shown.
